...
describe('VirtualMemory', () => {
  test('should allocate page tables correctly', () => {
    ...
    const textSegmentAddress = virtualMemory.segmentAddresses[Segment.TEXT];
    ...
    const dataSegmentAddress = virtualMemory.segmentAddresses[Segment.DATA];
    ...
    const stackSegmentAddress = virtualMemory.segmentAddresses[Segment.STACK];
    ...
    const heapSegmentAddress = virtualMemory.segmentAddresses[Segment.HEAP];
