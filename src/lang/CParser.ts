...
export class CParser extends Parser {
	...
	public start(): StartContext {
		...
		this.enterRule(_localctx, 0, CParser.RULE_start);
		try {
	...
	public expression(_p?: number): ExpressionContext {
		...
		this.enterRecursionRule(_localctx, 2, CParser.RULE_expression, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 1:
						...
						this.state = 15;
						(_localctx as PowerContext)._operator = this.match(CParser.POW);
						this.state = 16;
...
export class StartContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return CParser.RULE_start; }
	// @Override
...
export class NumberContext extends ExpressionContext {
	public NUMBER(): TerminalNode { return this.getToken(CParser.NUMBER, 0); }
...
export class PowerContext extends ExpressionContext {
	...
	public POW(): TerminalNode { return this.getToken(CParser.POW, 0); }
	constructor(ctx: ExpressionContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
